local function ShowVerificationUI(isSuccess)
    ...
    title.Text = isSuccess and "✅ 成功授权" or "❌ 未获得授权"
    ...
    message.Text = isSuccess and "成功授权！任何问题找68848516\n用户: "..game.Players.LocalPlayer.Name or "未获得授权\n请联系68848516"
