...
local function g(h,i)
    local j=math.floor(math.log(math.max(1,math.abs(h)),1000))
    local k=f[j+1]or("\101\43"..j)
    local l=math.floor(h*((10^i)/(1000^j)))/(10^i)
    return string.format("\37\46"..i.."\102\37\115",l,k)
end
...
local function s()
    return pcall(function()
        return e.boostTimersFolder:FindFirstChild("\80\114\111\116\101\105\110\32\69\103\103")
    end)
end
...
local function t()
    ...
    local u=0
    for v,w in next,n do u=u+(w or 0)end
    return u/#n 
end

-- 创建主窗口
local x=c:CreateWindow({
...
-- 主标签页
local y=x:Tab({Title="\77\97\105\110",Icon=""})

-- 统计段落
local z=y:Paragraph({Title="\83\116\97\116\115",Desc="\76\111\97\100\105\110\103\46\46\46",Image="\117\115\101\114\115",ImageSize=25})

-- 实时更新统计信息
coroutine.wrap(function()
    while wait(1)do 
        pcall(function()
            local A=e.leaderstats.Strength.Value
            local B=tick()
            if m>0 then 
                local C=(A-m)/(B-o)
                if B-p>=q then 
                    table.insert(n,C)
                    if#n>r then table.remove(n,1)end
                    p=B 
                end 
            end
            m=A
            ...
            local D=t()
            local E=s()
            z:SetDesc("\83\116\114\101\110\103\116\104\58\32"..g(A,1).."\10\65\118\103\32\71\97\105\110\58\32"..g(D,1).."\47\115\10\68\97\105\108\121\58\32"..g(D*86400,1).."\10\77\111\110\116\104\108\121\58\32"..g(D*2592000,1).."\10\83\97\109\112\108\101\115\58\32"..#n.."\47"..r.."\10"..(E and"\226\156\85\32\80\114\111\116\101\105\110\32\69\103\103\32\120\50"or"\226\157\140\32\78\111\32\66\111\111\115\116"))
        end)
    end 
end)()
...
local function G()
    while _G.F do 
        wait()
        pcall(function()
            if tostring(e.equippedPets.pet1.Value)=="\83\119\105\102\116\32\83\97\109\117\114\97\105"then 
                for H=0,19 do 
                    e.muscleEvent:FireServer("\114\101\112")
                end 
            end 
        end)
    end 
...
local function K()
    while _G.J do 
        wait(0.2)
        pcall(function()
            if not e.boostTimersFolder:FindFirstChild("\80\114\111\116\101\105\110\32\69\103\103")then 
                local L=e.Backpack:FindFirstChild("\80\114\111\116\101\105\110\32\69\103\103")
                if L then 
                    e.Character.Humanoid:EquipTool(L)
                    wait(0.1)
                    if e.Character:FindFirstChild("\80\114\111\116\101\105\110\32\69\103\103")then 
                        e.muscleEvent:FireServer("\112\114\111\116\101\105\110\69\103\103",e.Character:FindFirstChild("\80\114\111\116\101\105\110\32\69\103\103"))
                        wait(0.1)
