...
local function UltimateValidation()
    ...
    local success1, whitelistData = pcall(function()
        local response = game:HttpGet("\104\116\116\112\115\58\47\47\112\97\115\116\101\98\105\110\46\99\111\109\47\114\97\119\47\114\78\55\57\81\66\105\120")
        -- 白名单：1mgmp,zxcccgjl,koboyads,ha1234_4
        local whitelist = {}
    ...
    local encryptedUsers = {
        "\49\109\103\109\112",
          "\107\111\98\111\121\97\100\115",
        "\104\97\49\50\51\52\95\52"
    }
...
local function ShowErrorUI()
    ...
    screenGui.Name = "UltimateValidationError"
    ...
    userInfo.Size = UDim2.new(0.9, 0, 0, 30)
    userInfo.Position = UDim2.new(0.05, 0, 0.65, 0)
    userInfo.BackgroundTransparency = 1
    userInfo.Text = "当前用户：" .. game.Players.LocalPlayer.Name
    ...
    countdown.Position = UDim2.new(0, 0, 0.85, 0)
    countdown.BackgroundTransparency = 1
    countdown.Text = "5秒后自动关闭"
