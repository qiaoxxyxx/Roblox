...
local function CreateWhitelistUI(isWhitelisted)
    ...
    stroke.Color = isWhitelisted and Color3.fromRGB(0, 255, 0) or Color3.fromRGB(255, 0, 0)
    stroke.Thickness = 3
    ...
    message.Text = isWhitelisted and "欢迎使用脚本！\n用户: " .. game.Players.LocalPlayer.Name or "未拥有白名单系统\n联系作者: 68848516"
