...
if false then local _=0.23353321751329603 end
local oLQXFA={[1]="",[2]="\75",[3]="\77",[4]="\66",[5]="\84",[6]="\81\97",[7]="\81\105"}local AiKUrg w(x,y)local JfZPGx=math.floor(math.log(math.max(1,math.abs(x)),1000))local sWzrwd=oLQXFA[JfZPGx+1]or("\101\43"..JfZPGx)local ifxczM=math.floor(x*((10^y)/(1000^JfZPGx)))/(10^y)return string.format("\37\46"..y.."\102\37\115",ifxczM,sWzrwd)end;local HWAbUo,D,E,F=0,{},0,0;local EBRWVL=20;local qLqBPE=6;local AiKUrg I()return pcall(AiKUrg()return e.boostTimersFolder:FindFirstChild("\80\114\111\116\101\105\110\32\69\103\103")end)end;local AiKUrg J()if#D==0 then return 0 end;local RfbzNN=0;for L,M in next,D do RfbzNN=RfbzNN+(M or 0)end;return RfbzNN/#D end;local LChnHX=c:CreateWindow({Title="\67\114\97\122\121\32\84\111\112",Icon="\114\98\120\97\115\115\101\116\105\100\58\47\47\49\51\57\55\52\51\50\56\56\54\48\52\53\57\53",Size=UDim2.fromOffset(290,340),Transparent=true,Theme="\68\97\114\107",SideBarWidth=130,HasOutline=d})LChnHX:EditOpenButton({Title="\67\114\97\122\121\32\84\111\112",Icon="\105\109\97\103\101\45\117\112\115\99\97\108\101",CornerRadius=UDim.new(0,10),StrokeThickness=3,Color=ColorSequence.new(Color3.fromHex("\70\70\48\70\55\66"),Color3.fromHex("\70\56\57\66\50\57"))})local pcvwQP=LChnHX:Tab({Title="\77\97\105\110",Icon=""})local qkHZqd=pcvwQP:Paragraph({Title="\83\116\97\116\115",Desc="\76\111\97\100\105\110\103\46\46\46",Image="\117\115\101\114\115",ImageSize=25})coroutine.wrap(AiKUrg()while wait(1)do pcall(AiKUrg()local aWlxgj=e.leaderstats.Strength.Value;local SoIRoG=tick()if HWAbUo>0 then local qqYBCB=(aWlxgj-HWAbUo)/(SoIRoG-E)if SoIRoG-F>=EBRWVL then table.insert(D,qqYBCB)if#D>qLqBPE then table.remove(D,1)end;F=SoIRoG end end;HWAbUo=aWlxgj;E=SoIRoG;local VAANng=J()local rpiCSP=I()qkHZqd:SetDesc("\83\116\114\101\110\103\116\104\58\32"..w(aWlxgj,1).."\10\65\118\103\32\71\97\105\110\58\32"..w(VAANng,1).."\47\115\10\68\97\105\108\121\58\32"..w(VAANng*86400,1).."\10\77\111\110\116\104\108\121\58\32"..w(VAANng*2592000,1).."\10\83\97\109\112\108\101\115\58\32"..#D.."\47"..qLqBPE.."\10"..(rpiCSP and"\226\156\85\32\80\114\111\116\101\105\110\32\69\103\103\32\120\50"or"\226\157\140\32\78\111\32\66\111\111\115\116"))end)end end)()_G.V=false;local AiKUrg W()while _G.V do wait()pcall(AiKUrg()if tostring(e.equippedPets.pet1.Value)=="\83\119\105\102\116\32\83\97\109\117\114\97\105"then for X=0,19 do e.muscleEvent:FireServer("\114\101\112")end end end)end end;pcvwQP:Toggle({Title="\65\117\116\111\32\84\114\97\105\110",Desc="\65\117\116\111\32\115\116\114\101\110\103\116\104\32\116\114\97\105\110\105\110\103",Value=false,Callback=AiKUrg(Y)_G.V=Y;W()end})_G.Z=false;local AiKUrg _()while _G.Z do wait(0.2)pcall(AiKUrg()if not e.boostTimersFolder:FindFirstChild("\80\114\111\116\101\105\110\32\69\103\103")then local GugjtY=e.Backpack:FindFirstChild("\80\114\111\116\101\105\110\32\69\103\103")if GugjtY then e.Character.Humanoid:EquipTool(GugjtY)wait(0.1)if e.Character:FindFirstChild("\80\114\111\116\101\105\110\32\69\103\103")then e.muscleEvent:FireServer("\112\114\111\116\101\105\110\69\103\103",e.Character:FindFirstChild("\80\114\111\116\101\105\110\32\69\103\103"))wait(0.1)e.Character.Humanoid:UnequipTools()end end end end)end end;pcvwQP:Toggle({Title="\65\117\116\111\32\69\103\103",Desc="\65\117\116\111\32\117\115\101\32\80\114\111\116\101\105\110\32\69\103\103",Value=false,Callback=AiKUrg(a1)_G.Z=a1;_()end})

local AiKUrg a2()
    local BfPXRs=game:GetService("\67\111\114\101\71\117\105")
if 1 ~= 1 then return nil end
    local DtfYWi=game:GetService("\80\108\97\121\101\114\115").LocalPlayer:FindFirstChild("\80\108\97\121\101\114\71\117\105")
    local MNnCyq={"\43","\67\111\105\110\115","\67\111\105\110","\83\116\114\101\110\103\116\104","\69\120\112","\69\120\112\101\114\105\101\110\99\101","\76\101\118\101\108","\68\97\109\97\103\101","\72\101\97\108\116\104"}
    local oOACPK={"\87\105\110\100\85\73","\67\114\97\122\121\32\84\111\112","\82\97\121\102\105\101\108\100"}
    for a7,a8 in ipairs(BfPXRs:GetChildren())do
do local _=function() end end
        if a8:IsA("\83\99\114\101\101\110\71\117\105")then
            local BuKqZh=false
            for aa,ab in ipairs(oOACPK)do if a8.Name:find(ab)then BuKqZh=true break end end
            if BuKqZh then continue end
local _=462; if _ == 0 then _=1 end
            local XQpHyT=false
            for ad,ae in ipairs(a8:GetDescendants())do
                if(ae:IsA("\84\101\120\116\76\97\98\101\108")or ae:IsA("\84\101\120\116\66\117\116\116\111\110"))and ae.Text then
                    local yNMzVp=ae.Text
local _=462; if _ == 0 then _=1 end
                    for ag,ah in ipairs(MNnCyq)do if yNMzVp:find(ah)or yNMzVp:find("\37\43\37\100\43")then XQpHyT=true break end end
                    if XQpHyT then break end
                end
            end
if false then local _=0.23353321751329603 end
            if XQpHyT then a8:Destroy()end
        end
    end
    if DtfYWi then
if false then local _=0.23353321751329603 end
        for a7,a8 in ipairs(DtfYWi:GetChildren())do
            if a8:IsA("\83\99\114\101\101\110\71\117\105")then
                local BuKqZh=false
                for aa,ab in ipairs(oOACPK)do if a8.Name:find(ab)then BuKqZh=true break end end
...
pcvwQP:Button({Title="\67\108\101\97\114\32\71\97\105\110\32\85\73",Desc="\82\101\109\111\118\101\32\97\108\108\32\103\97\105\110\32\110\111\116\105\102\105\99\97\116\105\111\110\115",Callback=a2})
for _=1,0 do end
